...
#define queueQUEUE_TYPE_COUNTING_SEMAPHORE	( 1U )
#define queueQUEUE_TYPE_BINARY_SEMAPHORE	( 2U )
...
/*
 * Utilities to query queues. 
 * It is only a certain momentary value that this function returns.
 */
...
#define vQueueEnterCritical( pxQueue ) \
	taskENTER_CRITICAL( &( pxQueue->xQueueLock ) )

#define vQueueExitCritical( pxQueue ) \
